...
export default function CVGenerator() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div
        ref={cvRef}
        className="bg-white text-black p-8 max-w-4xl mx-auto shadow-lg print:shadow-none"
        id="cv-content"
      >
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-700">
            DevOps Engineer and System Administrator with hands-on experience in AWS, Windows, Linux, and Python. I have
            a solid understanding of CI/CD pipelines, infrastructure automation, and cloud-native deployments, backed by
            a background as a System Administrator.
          </p>
        ...
        <div className="mt-6">
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700">
              ...
              <li>Optimized Linux-based servers, improving system performance through effective process management.</li>
              <li>
                Implemented load balancers and network optimizations to improve application scalability and reliability.
              </li>
              <li>
                Gained hands-on experience with Terraform for Infrastructure as Code (IaC) and AWS resource management.
              </li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5 mt-2 text-gray-700">
              ...
              <li>Provided technical support while monitoring system performance to maintain uptime and efficiency.</li>
            </ul>
          </div>
        </div>
